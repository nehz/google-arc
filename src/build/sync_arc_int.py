...
_ARC_ROOT = os.path.join(_SCRIPT_DIR, os.pardir, os.pardir)
_ARC_INTERNAL_DIR = os.path.join(_ARC_ROOT, 'internal')
_GMS_BUILD_DIR = os.path.join(_ARC_ROOT, 'out', 'gms-build')
_GCSA_BUILD_DIR = os.path.join(
    _ARC_ROOT, 'out', 'google-contacts-sync-adapter-build')
...
def run():
  ...
  for d in [_GMS_BUILD_DIR, _GCSA_BUILD_DIR]:
