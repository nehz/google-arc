...
class _Options(object):
  ...
  def is_mmap_irt_logging(self):
    return _MMAP_IRT_LOGGING in self._loggers
  ...
  def parse(self, args):
    ...
    # TODO(crbug.com/340598): We probably want to make this a runtime
    # configuration, or remove this.
    parser.add_argument('--enable-ndk-translation', action='store_true',
                        help='Enable NDK translation on Bare Metal ARM.')
