...
# ARC MOD BEGIN
# Fix the include path so we can find the files.
CHROMIUM_PATH := $(LOCAL_PATH)/../../../external/chromium_org
# ARC MOD END
...
# ARC MOD BEGIN
# This is manually generating its own Makefile rules, which we do not support.
# Instead, change the name, pretend it is a static Java library and then
# manually generate an .apk
LOCAL_MODULE := webview_library
