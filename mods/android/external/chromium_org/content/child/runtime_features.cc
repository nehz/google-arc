...
static void SetRuntimeFeatureDefaultsForPlatform() {
  ...
  /* ARC MOD BEGIN */
  // Disable MediaSource as it causes playback issues (crbug.com/426200)
  // and is not really required. According to the Clank team, this will break
  // some websites, but should be OK as sites like youtube will fallback
  // to urls if MediaSource is not supported. We can leave it like that
  // until ARC is updated to M39.
  // TODO(crbug.com/428888): Re-enable once Android switches to Chrome M39.
