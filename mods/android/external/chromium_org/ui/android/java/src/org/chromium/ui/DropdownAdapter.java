...
public class DropdownAdapter extends ArrayAdapter<DropdownItem> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        /* ARC MOD BEGIN */
        // For some reason, the textColor from dropdown_item.xml is being
        // overridden to be white for dark themes.  This does not happen on
        // regular Android tablets.  Set the colors manually to white and black
        // which are close to what the dropdown is on tablets with all themes.
