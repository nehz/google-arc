...
// ARC MOD BEGIN chromium-base-stlport-and-libcxx
#if defined(OS_ANDROID) && !defined(_USING_LIBCXX)
// ARC MOD END
...
// ARC MOD BEGIN chromium-base-stlport-and-libcxx
// Even if upstream chromium base library stop supporting STLport on Android,
// ARC still need to build it with both STLport and libc++.
#if defined(OS_ANDROID) && !defined(_USING_LIBCXX)
// ARC MOD END
#include <hash_map>
#include <hash_set>
...
// ARC MOD BEGIN chromium-base-stlport-and-libcxx
#endif  // !defined(OS_ANDROID) || defined(_USING_LIBCXX)
// ARC MOD END
