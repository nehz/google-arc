...
uint64 _xgetbv(uint32 xcr) {
  /* ARC MOD BEGIN UPSTREAM chromium-nacl-disable-xgetbv */
#if defined(__native_client__)
  // NaCl does not allow to call xgetbv. Note that this causes AVX to be
  // disabled.
  return 0;
#else
  /* ARC MOD END UPSTREAM chromium-nacl-disable-xgetbv */
  uint32 eax, edx;
