...
// ARC MOD BEGIN
// PPAPI does not supply this value.  Act like there is only ever one recorded
// trace.
...
//                    unsigned char flags)
// ARC MOD BEGIN
// The above declaration in comments is out of date.  There is a convertables
// parameter before flags.  We cannot handle it with PPAPI, so ignore those
// values.
#define TRACE_EVENT_API_ADD_TRACE_EVENT(a,b,c,d,e,f,g,h,i,j) \
    arc::trace::AddTraceEvent(a,b,c,d,e,f,g,h,j)
// ARC MOD END
...
//                    unsigned char flags)
// ARC MOD BEGIN
// PPAPI trace interface cannot take thread id and timestamp.
// TODO(crbug.com/424810): Use
// arc::trace::AddTraceEventWithThreadIdAndTimestamp when that is possible.
#define TRACE_EVENT_API_ADD_TRACE_EVENT_WITH_THREAD_ID_AND_TIMESTAMP(a,b,c,d,e,f,g,h,i,j,k,l) \
    (void)a; \
    (void)b; \
    (void)c; \
    (void)d; \
